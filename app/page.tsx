...
import { Share2, Heart, Sparkles, Check } from 'lucide-react';
...
// defaultQuotes 配列は完全に削除されました

export default function Home() {
  // currentQuoteの初期値をnull（空）に変更
...
  // getRandomQuote関数は削除されました

  const shareQuote = async () => {
    // currentQuoteがnullの場合に何もしないようにする安全策
